...
public class FullyCovariantExtendedMututallyExcitingExponentialPowerlawApproximationProcessTest extends TestCase
{
  ...
  public static FullyCovariantExtendedMutuallyExcitingExponentialPowerlawApproximationProcess
  ...
  public static FullyCovariantExtendedMutuallyExcitingExponentialPowerlawApproximationProcess
         constructProcess()
  {
    final FullyCovariantExtendedMutuallyExcitingExponentialPowerlawApproximationProcess process =
                                                                                                new FullyCovariantExtendedMutuallyExcitingExponentialPowerlawApproximationProcess(2);

    process.τ.assign(1);
    process.ε.assign( new double[][] { { 0, 0.01 }, { 0.02, 0 } } );
